            ...
            <div class="signin-form">
                ...
                <form method="POST" action="{{route('login.new') }}" class="" id="login-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input id="email" type="email" class="@error('email') is-invalid @enderror" placeholder="Email của bạn" name="email" value="{{ old('email') }}" required autocomplete="off" autofocus>
                            @error('email')
