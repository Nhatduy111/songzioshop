            ...
            <div class="col-lg-6">
                <div class="shop-single-content">
                    ...
                    <form action="{{route('cart.add')}}" method="post" id="formMainAddCart">
                        ...
                        <div class="row">
                        <div class="col-md-6 col-xs-12" style="margin-top: 40px; border: 1px solid #ccc">
                        <select name="kichthuocbanh"  style="height: 40px" required>
                                <option>Chọn kích thước bánh</option>
                                <option>16cm</option>
                                <option>18cm</option>
                                <option>20cm</option>
                        </select>
                            ...
                            <input required class="w3-input w3-animate-input" placeholder="Chữ in trên bánh"
                         type="text" style="margin-top: 40px; height: 43px; border: 1px solid #ccc "></div>
                        </div>
                ...
                <div class="social-share">
                    ...
                    <ul class="social">
                        ...
                        <div class="fb-share-button" data-href="{{$urlProduct}}" data-layout="button_count" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{$urlProduct}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="single-form">
                                        <label class="font-weight-bold" style="font-size: 16px;">Nội dung đánh giá</label>
