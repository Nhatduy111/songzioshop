            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-shipping">
                    ...
                    <div class="shipping-content">
                        ...
                        <p>Giao hàng miễn phí trên địa bàn Cần Thơ</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-9 col-sm-11">
                <div class="section-title text-center">
                    <h2 class="title">Sản phẩm và phụ kiện bánh kem mới về</h2>
                    <p>Những chiếc bánh kem và phụ kiện không phải là toàn bộ cuộc sống của ta nhưng lại là một mảnh ghép không thể thiếu cho các buổi tiệc.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="align-items: center">
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <p>Với mong muốn được đồng hành, truyền cảm hứng và khuyến khích các bạn nam giới trẻ dám bước ra khỏi vùng an toàn để tự do, tự tin thể hiện chính mình theo phong cách phù hợp với bản thân. Thương hiệu thời trang HERO đầu tư tâm huyết nghiên cứu thiết kế chi tiết từng sản phẩm để có thể mang lại những trải nghiệm mới cho khách hàng, cũng là thông điệp muốn nhắn nhủ đến các bạn trẻ hãy cho bản thân trải nghiệm, dám thay đổi, bứt phá để vươn lên.
                    </p>
                    <ul>
        ...
        <div class="product-wrapper">
            <div class="product-tab-menu">
                <ul class="nav justify-content-center" role="tablist">
                    <li>
                        <a class="active" data-toggle="tab" href="#tab1" role="tab">Bánh kem</a>
                    </li>
                    <li>
            ...
            <div class="tab-content product-items-tab">
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel">
                    <div class="swiper-container product-active">
                        <div class="swiper-wrapper">
                            @isset($arrlistsNotCakes)
                            @foreach ($arrlistsNotCakes as $arrlist)
                            <div class="swiper-slide">
