...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $arrlists = array();
        $accept = ['BANHFONDANT_00', 'BANHCUOI_00','BANHCHOCOLATE_00'];
        ...
        $arrlistsNotCakes = array(); 
        $except = ['AO_00', 'AOSOMIDAI_00'];
        ...
        for ($i = 0; $i <= 16; $i += 2) {
            $data = Product::select('product_id', 'product_name', 'product_description')->whereHas('getArchive', function ($query) {
                ...
                ->take(2)
                ->get();
            array_push($arrlistsNotCakes, $data);
        }
        ...
        // return $posts;
        return view('frontend.pages.home.index', compact('dataSlides', 'dataNewPets', 'arrlists', 'arrlistsNotCakes', 'posts'));
    }
